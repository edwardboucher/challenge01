...
def __virtual__():
    '''
    Only load ntpmodule if requests package is available
    '''
    if HAS_REQUESTS:
        return __virtual_name__
    else:
        return False, 'The ntpmodule module cannot be loaded: requests package unavailable, check pip.'


def get(signs=None):
    '''
    Gets the Current NTP state of salt nodes
